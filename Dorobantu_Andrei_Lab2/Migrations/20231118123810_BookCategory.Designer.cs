...
namespace Dorobantu_Andrei_Lab2.Migrations
{
    ...
    [Migration("20231118123810_BookCategory")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Dorobantu_Andrei_Lab2.Models.BookCategory", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Dorobantu_Andrei_Lab2.Models.Category", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Dorobantu_Andrei_Lab2.Models.BookCategory", b =>
                {
                    b.HasOne("Dorobantu_Andrei_Lab2.Models.Book", "Book")
                        .WithMany("BookCategories")
                        .HasForeignKey("BookID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Dorobantu_Andrei_Lab2.Models.Category", "Category")
                        .WithMany("BookCategories")
